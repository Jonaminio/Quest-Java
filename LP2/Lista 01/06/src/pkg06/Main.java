...
/**
 *
 * Faça um programa que calcule as raízes da equação de 2o
 grau.
Lembre-se que: x = (−b ± √∆)/2a onde ∆ = b2– 4ac
E ax2 + bx + c = 0 representa uma equação do 2
o grau. A variável ’a’ tem que ser diferente
de zero. Caso seja igual, imprima a mensagem “Não é equação do segundo grau”. Se ∆ < 0,
não existe real. Imprima a mensagem “Não existe raiz”. Se ∆ = 0, existe uma raiz real.
Imprima a raiz e a mensagem Raiz Única. Se ∆ >= 0, imprima as duas raízes
 * @author jonas
 */
public class Main {
